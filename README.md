...
Now update your package.json file, changing the `"type": "module",` line and adding the two script lines for build and start. (You can leave the name line set to whatever it is. And the order of the members doesn't matter.)
